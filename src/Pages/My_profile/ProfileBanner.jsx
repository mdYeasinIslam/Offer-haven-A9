        ...
        <div className="relative">
            <figure>
                <img src="/assets/Colored Patterns.svg"
                    className="w-full h-40 md:h-full xl:rounded-xl"
                    alt="" />
            </figure>
            {
                message ?
                    ...
                    :
            <div className="absolute top-3 md:top-10 lg:top-16 md:space-y-5 text-white md:w-[full] md:left-[8%] xl:left-[15%] text-center ">
